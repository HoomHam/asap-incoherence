...
emcc csrc/kasap_api.c csrc/nufft.c -O3 -msimd128 \
  ...
  -s EXPORTED_FUNCTIONS='["_kasap_generate","_kasap_get_kx","_kasap_get_ky","_kasap_get_kz","_kasap_get_gx","_kasap_get_gy","_kasap_get_gz","_kasap_get_basis","_kasap_get_reprot","_kasap_get_total","_kasap_hedgehog","_nufft_psf","_nufft_get_psf_re","_nufft_get_psf_im","_nufft_get_dcf","_wasm_malloc","_wasm_free"]' \
